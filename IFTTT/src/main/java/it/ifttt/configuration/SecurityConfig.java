...
@ComponentScan(basePackages={"it.ifttt.services.security"}) //Da modificare?
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	@Override
	  protected void configure(AuthenticationManagerBuilder auth)
	    ...
	    .usersByUsernameQuery("SELECT username,password,enabled FROM userifttt WHERE username=?")
	    .authoritiesByUsernameQuery("SELECT U.username,role FROM role R, userifttt U WHERE U.username=? AND U.id=R.user");
		/*auth.
