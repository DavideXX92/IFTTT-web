...
CREATE TABLE `trigger` (
  ...
  PRIMARY KEY (`idTrigger`,`idChannel`),
  KEY `channel_fk_idx` (`idChannel`),
  CONSTRAINT `channel_fk` FOREIGN KEY (`idChannel`) REFERENCES `channel` (`idChannel`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2016-11-10 11:01:57
